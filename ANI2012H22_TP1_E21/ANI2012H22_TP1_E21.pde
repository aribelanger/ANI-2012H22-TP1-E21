...
Movie[] videos = new Movie[6]; // array vidéos
PImage carte; // image arrière-plan principal
PImage UQAM; // image arrière-plan jeu ***************************à supprimer pour projet expo
PImage [] dolls = new PImage [5]; // **************************à supprimer pour projet expo
...
int numFrames = 3;  // quantité frames (images)
...
// section se défaroucher - ************à supprimer pour projet expo
...
// pour déplacement avec souris section se défaroucher ***************************à supprimer pour projet expo
...
final int stateTexte = 2; //crédit
final int stateUQAM = 3; //vidéo
final int stateAngrignon = 4;
final int stateMaison = 5;
final int stateJarry = 6;
final int stateCollection = 7; // se défaroucher **********************à supprimer pour projet expo
final int stateBoucle = 8; // boucle de vidéos
...
void setup() {
  ...
  videos[1] = new Movie (this, "video1.mp4"); //Jarry////// A REMPLACER PAR LE BON VIDÉO!!!!!!!!!!!
  videos[2] = new Movie (this, "video2.mp4");//Angrignon
  videos[3] = new Movie (this, "video3.mp4");//UQAM
  videos[4] = new Movie (this, "video4.mp4"); //Windsor//// À REMPLACER PAR LE BON VIDÉO!!!!!!!!!!!!
  videos[5] = new Movie (this, "video5.mp4"); //Boucle//// À REMPLACER PAR LE BON VIDÉO!!!!!!!!!!!!
  ...
  //pour les images à déplacer section se défaroucher ************************ à supprimer pour projet expo
  ...
  dolls4H = 157;
  UQAMX = 215.25;
  UQAMY = 19.75;// supprimer jusqu'ici
}
