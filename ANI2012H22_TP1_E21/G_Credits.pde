void showText() {
  ...
  for (int i =0; i <texteContent.length; i++)
    text(texteContent[i], rectTextX-rectTextW/2+30, 65+23*i);
  ...
  for (int i =0; i <credit.length; i++)
    text(credit[i], (rectCredX+rectCredW/2)-15, (rectCredH*3)+30+18*i);
  ...
  textAlign(RIGHT);
  textSize(16.5);
  text("une cartographie d'appartenance", rectTitre2X+rectTitreW/2-10, rectTitre2Y);
  textFont(typoS1);
  fill(90);
  textAlign(RIGHT);
  textSize(16.5);
